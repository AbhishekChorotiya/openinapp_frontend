    ...
    <div className={styles.outter}>
      ...
      <div className={styles.right}>
        ...
        <div className={styles.right_content}>
          <span style={{fontWeight:'bold',fontSize:'2rem',marginBottom:'0.4rem'}}>Sign In</span>
          <span style={{fontSize:'0.8rem',marginBottom:'1.5rem'}}>Sign in to your account</span>
          <div className={styles.option_div}>
            <div style={{width:'48%',position:'relative',height:'2rem',cursor:'pointer'}}>
          ...
          <div className={styles.form}>
            ...
            <span style={{color:'#346BD4',marginBottom:'1rem',cursor:'pointer'}}>Forgot password?</span>
            <Link style={{display:'flex',width:'100%',textDecoration:'none'}} href='/upload'>
            <button>Sign In</button>
            </Link>
          </div>
            <span className={styles.bottom_txt} style={{color:'#858585',alignSelf:'center',cursor:'pointer'}}>Don’t have an account? <span style={{color:'#346BD4'}}>Register here</span></span>
        </div>
